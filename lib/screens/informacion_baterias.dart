...
class informacionBaterias extends StatefulWidget {
  @override
  _informacionBaterias createState() => _informacionBaterias();
}

class _informacionBaterias extends State<informacionBaterias> {
  ...
  Future<void> fetchDataFromAPI(String numSerie) async {
    final apiUrl = Uri.parse(
        'http://192.168.1.160:5000/baterias/$numSerie'); // Reemplaza con la URL y el endpoint correctos
